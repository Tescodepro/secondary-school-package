...
<head>
  <meta charset="utf-8">
    ...
    <title>School Portal - Registration </title>
						...
						<div class="bg-white rounded30 shadow-lg">
							...
							<div class="p-40">
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Already have an account?<a href="index.php" class="text-danger ml-5"> Sign In</a></p>
								</div>
							</div>
						</div>								
...
<!-- Mirrored from eduadmin-template.multipurposethemes.com/bs4/main/auth_register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Jun 2022 10:14:01 GMT -->
</html>
