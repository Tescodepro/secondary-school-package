											...
											<form action="result.php" method="post">
												<div class="box-body">
													...
													<div class="row">
														...
														<div class="col-12 col-lg-12 col-xl-12">
															<button type="submit" class="btn btn-success btn-sm" name="search_result">Search <span class="path1"></span><span class="path2"></span><i class="glyphicon glyphicon-search"></i> </button>														</div>
																	...
																	if (isset($_POST['search_result'])) {
																		...
																		while($row_result_result = mysqli_fetch_array($result_result)) {
																			if ($row_result_result['user_id'] == $unique_id) {
																				...
																				$total_score = intval($row_result_result['exam_score'])+intval($row_result_result['total_ca']);
																				if ($total_score >= 70) {
																					$grade_point = 'A';
																				...
																				// average score
																				$average_score = "SELECT subject, sum(exam_score + total_ca) as total, COUNT(subject) as sub FROM result GROUP BY subject";
