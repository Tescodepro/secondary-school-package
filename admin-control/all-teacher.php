                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($run_teacher_data)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{$row['gender']}</td>
                                                    <td>
                                                        <a href='all-teacher.php?id={$row['unique_id']}&delete=true' class='btn btn-danger text-white'><i class='fas fa-trash'></i></a>
                                                        <a href='teacher-details.php?id={$row['unique_id']}' class='btn btn-success text-white'><i class='fas fa-eye'></i></a>
                                                        <a href='all-teacher.php?id={$row['unique_id']}&modal=true' class='btn btn-primary text-white'><i class='fas fa-file-upload'></i></a>
                                                    </td>
                                                </tr>";
                                                $i++;
                                            }
