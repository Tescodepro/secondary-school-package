                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="assign-teacher.php" class="nav-link"><i class="fas fa-angle-right"></i>Assign Teacher</a>
                                </li>
                            </ul>
                        </li>
                        <!-- <li class="nav-item sidebar-nav-item">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link"><i class="flaticon-technological"></i><span>Bursary</span></a>
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="all-fees.php" class="nav-link"><i class="fas fa-angle-right"></i>Add Payment</a>
                                </li>
                                <li class="nav-item">
                                    <a href="all-expense.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Student Payment</a>
                                </li>
                                <li class="nav-item">
                                    <a href="add-outstanding-pay.php" class="nav-link"><i class="fas fa-angle-right"></i>Add
                                        Outstanding Payment</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item ">
                            <a href="classes.php" class="nav-link"><i class="flaticon-maths-class-materials-cross-of-a-pencil-and-a-ruler"></i><span>Classes</span></a>
                        </li>
                        <li class="nav-item">
