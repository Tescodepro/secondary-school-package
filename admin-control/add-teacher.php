                        ...
                        <form class="new-added-form" action="includes/process.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input required type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="add_teacher" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Save</button>
