                                            ...
                                            <form class="new-added-form" action="includes/process.php" method="POST">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 form-group mg-t-8">
                                                        <button type="submit" name="add_payment" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Save</button>
                                                    </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                ...
                                                <?php
                                                    $i = 0;
                                                    $get_payment = "SELECT * FROM set_payment INNER JOIN classes ON classes.id = set_payment.class_id ";
                                                    ...
                                                    while($row_payment = mysqli_fetch_array($run_payment)){
                                                        ...
                                                        echo "
                                                            <tr>
                                                                ...
                                                                <td>$session</td>
                                                                <td> 
                                                                 <a href='all-fees.php?id=$id&modal=delete' style='margin-right:5%' class='btn btn-danger text-white waves-effect waves-light'><i class='fas fa-trash'></i></a>
                                                                 <a href='all-fees.php?id=$id&modal=edit' style='margin-right:5%' class='btn btn-success text-white waves-effect waves-light'><i class='fas fa-file-upload'></i></a>
                                                        </td>
                                                                 </tr>
                                                                 ";
                                                    } 
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="new-added-form" action="includes/process.php" method="POST">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 form-group mg-t-8">
                                                        <button type="submit" name="update_payment" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Save</button>
                                                    </div>
                                            </form>
                                        </div>
                                    </div>
